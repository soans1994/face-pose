...
train_annot_path = 'coco/annotations/annotations/coco_wholebody_train_v1.0.json'
val_annot_path = 'coco/annotations/annotations/coco_wholebody_val_v1.0.json'
...
train_generator = generator22(train_df, train_img_path, shuffle=True, batch_size=16, input_dim=(96,96), output_dim=(96,96))
validation_generator = generator22(val_df, val_img_path, shuffle=True, batch_size=16, input_dim=(96,96), output_dim=(96,96))
...
model.load_weights("unetcocofacebcel.hdf5") # 96,96,3   # 256 bs while training
...
plt.axis('off')
plt.savefig("poseface1.png", bbox_inches='tight', pad_inches=0)
plt.show()

# cv2.imshow("data", y_pred_train[index].sum(axis=-1))
# cv2.waitKey(0)
# cv2.destroyAllWindows()
plt.imshow(y_pred_train[index].sum(axis=-1), cmap="gray")
plt.axis('off')
plt.savefig("posemask1.png", bbox_inches='tight', pad_inches=0)
plt.show()
...
#plt.imshow(train_x[0])#color
plt.axis('off')
plt.savefig("posekeys1.png", bbox_inches='tight', pad_inches=0)
plt.show()
plt.close()
...
plt.axis('off')
plt.savefig("poseface2.png", bbox_inches='tight', pad_inches=0)
plt.show()

plt.imshow(y_pred_train[index + 1].sum(axis=-1), cmap="gray")
plt.axis('off')
plt.savefig("posemask2.png", bbox_inches='tight', pad_inches=0)
plt.show()

pred_list = []
for k in range(68):
    xpred, ypred = findCoordinates(np.array(y_pred_train[index+1]).reshape(96, 96, 68)[:, :, k])  # maskToKeypoints(mask_pred[:, :, k])
    pred_list.append(xpred)
    pred_list.append(ypred)
pred_list = np.array(pred_list, dtype=np.float32) #42,
print(pred_list.shape)
...
for i in range(0, 136, 2):
    ...
    # plt.scatter(points[:, 0], points[:, 1])
    # cv2.circle(img, (int(points[i]), int(points[i + 1])), 3, (0, 255, 0), thickness=-1)  # , lineType=-1)#, shift=0)
plt.imshow(train_x[index+1], cmap='gray')#gray
#plt.imshow(train_x[0])#color
plt.axis('off')
plt.savefig("posekeys2.png", bbox_inches='tight', pad_inches=0)
plt.show()
plt.close()

plt.imshow(train_x[index + 2])
plt.axis('off')
plt.savefig("poseface3.png", bbox_inches='tight', pad_inches=0)
plt.show()

plt.imshow(y_pred_train[index + 2].sum(axis=-1), cmap="gray")
plt.axis('off')
plt.savefig("posemask3.png", bbox_inches='tight', pad_inches=0)
plt.show()

pred_list = []
for k in range(68):
    xpred, ypred = findCoordinates(np.array(y_pred_train[index+2]).reshape(96, 96, 68)[:, :, k])  # maskToKeypoints(mask_pred[:, :, k])
    pred_list.append(xpred)
    pred_list.append(ypred)
pred_list = np.array(pred_list, dtype=np.float32) #42,
print(pred_list.shape)
...
for i in range(0, 136, 2):
    ...
    # plt.scatter(points[:, 0], points[:, 1])
    # cv2.circle(img, (int(points[i]), int(points[i + 1])), 3, (0, 255, 0), thickness=-1)  # , lineType=-1)#, shift=0)
plt.imshow(train_x[index+2], cmap='gray')#gray
#plt.imshow(train_x[0])#color
plt.axis('off')
plt.savefig("posekeys3.png", bbox_inches='tight', pad_inches=0)
plt.show()
plt.close()

plt.imshow(train_x[index + 3])
plt.axis('off')
plt.savefig("poseface4.png", bbox_inches='tight', pad_inches=0)
plt.show()


plt.imshow(y_pred_train[index + 3].sum(axis=-1), cmap="gray")
plt.axis('off')
plt.savefig("posemask4.png", bbox_inches='tight', pad_inches=0)
plt.show()

pred_list = []
for k in range(68):
    xpred, ypred = findCoordinates(np.array(y_pred_train[index+3]).reshape(96, 96, 68)[:, :, k])  # maskToKeypoints(mask_pred[:, :, k])
    pred_list.append(xpred)
    pred_list.append(ypred)
pred_list = np.array(pred_list, dtype=np.float32) #42,
print(pred_list.shape)
...
for i in range(0, 136, 2):
    ...
    # plt.scatter(points[:, 0], points[:, 1])
    # cv2.circle(img, (int(points[i]), int(points[i + 1])), 3, (0, 255, 0), thickness=-1)  # , lineType=-1)#, shift=0)
plt.imshow(train_x[index+3], cmap='gray')#gray
#plt.imshow(train_x[0])#color
plt.axis('off')
plt.savefig("posekeys4.png", bbox_inches='tight', pad_inches=0)
plt.show()
plt.close()

plt.imshow(train_x[index + 4])
plt.axis('off')
plt.savefig("poseface5.png", bbox_inches='tight', pad_inches=0)
plt.show()


plt.imshow(y_pred_train[index + 4].sum(axis=-1), cmap="gray")
plt.axis('off')
plt.savefig("posemask5.png", bbox_inches='tight', pad_inches=0)
plt.show()

pred_list = []
for k in range(68):
    xpred, ypred = findCoordinates(np.array(y_pred_train[index+4]).reshape(96, 96, 68)[:, :, k])  # maskToKeypoints(mask_pred[:, :, k])
    pred_list.append(xpred)
    pred_list.append(ypred)
pred_list = np.array(pred_list, dtype=np.float32) #42,
print(pred_list.shape)
...
for i in range(0, 136, 2):
    ...
    # plt.scatter(points[:, 0], points[:, 1])
    # cv2.circle(img, (int(points[i]), int(points[i + 1])), 3, (0, 255, 0), thickness=-1)  # , lineType=-1)#, shift=0)
plt.imshow(train_x[index+4], cmap='gray')#gray
#plt.imshow(train_x[0])#color
plt.axis('off')
plt.savefig("posekeys5.png", bbox_inches='tight', pad_inches=0)
plt.show()
plt.close()

plt.imshow(train_x[index + 5])
plt.axis('off')
plt.savefig("poseface6.png", bbox_inches='tight', pad_inches=0)
plt.show()


plt.imshow(y_pred_train[index + 5].sum(axis=-1), cmap="gray")
plt.axis('off')
plt.savefig("posemask6.png", bbox_inches='tight', pad_inches=0)
plt.show()

pred_list = []
for k in range(68):
    xpred, ypred = findCoordinates(np.array(y_pred_train[index+5]).reshape(96, 96, 68)[:, :, k])  # maskToKeypoints(mask_pred[:, :, k])
    pred_list.append(xpred)
    pred_list.append(ypred)
pred_list = np.array(pred_list, dtype=np.float32) #42,
print(pred_list.shape)
...
for i in range(0, 136, 2):
    ...
    # plt.scatter(points[:, 0], points[:, 1])
    # cv2.circle(img, (int(points[i]), int(points[i + 1])), 3, (0, 255, 0), thickness=-1)  # , lineType=-1)#, shift=0)
plt.imshow(train_x[index+5], cmap='gray')#gray
#plt.imshow(train_x[0])#color
plt.axis('off')
plt.savefig("posekeys6.png", bbox_inches='tight', pad_inches=0)
plt.show()
plt.close()