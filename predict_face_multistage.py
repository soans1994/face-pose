...
#from fcn_multistage5 import modelq
...
model = get_model()
#model.compile(optimizer="adam", loss=losses, metrics=["accuracy"])#original
#model.compile(optimizer="rmsprop", loss="mean_squared_error", metrics=["accuracy"])#original
#model.compile(optimizer="adam", loss=jaccard, metrics=["accuracy"])
#model.compile(optimizer="adam", loss="categorical_crossentropy", metrics=["accuracy"])
model.summary()
#model.load_weights("fcnfacemultistage53fusion.hdf5")
